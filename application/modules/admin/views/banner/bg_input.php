		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="#" class="current">Banner</a>			</div>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="widget-box">
							...
							<div class="well">
								<?php echo form_open_multipart("admin/banner/simpan"); ?>
								...
								<label for="menu">Gambar</label>
								<div class="cleaner_h5"></div>
								<input type="file" style="width:90%;" id="userfile" name="userfile" />
								<div class="cleaner_h10"></div>
